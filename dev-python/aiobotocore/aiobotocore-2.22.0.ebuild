...
SRC_URI="https://files.pythonhosted.org/packages/9c/4c/113c4f5611103bba8e5252805fbee7944f5d9541addba9a96b091c0c4308/aiobotocore-2.22.0.tar.gz"
...
RDEPEND="${PYTHON_DEPS}
	...
	<dev-python/awscli-1.38.4[${PYTHON_USEDEP}]
	>=dev-python/awscli-1.38.2[${PYTHON_USEDEP}]
